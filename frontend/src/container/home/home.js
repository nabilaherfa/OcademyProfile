            ...
            <>
                <div className='bg-background'>
                    <div className="w-auto p-3 lg:p-10 ">
                        <Carousel showThumbs={false} showStatus={false} dynamicHeight={true} autoPlay={true} infiniteLoop={true}>
                            <div className='text-white'>
                                ...
                                <div className='flex justify-end'>
                                    <button type="button" className="drop-shadow-2xl absolute bottom-12 bg-oren3 rounded-lg hover:bg-yellow-700 mx-8 md:my-3 lg:my-4">
                                        <Link to="/produk-KSN">
                                            <p className="text-xs md:text-lg lg:text-lg px-2 md:px-4 lg:px-4 py-1 md:py-2 lg:py-2 font-roboto">Coba Sekarang</p>
                                        </Link>
                                    </button>
                                </div>
                            </div>
                            <div className='text-white'>
                                ...
                                <div className="flex justify-start">
                                    <div className="p-5 text-left ">
                                        ...
                                        <p className="md:w-1/2 lg:w-1/2 py-8 md:py-16 lg:py-32 pr-8 text-xs md:text-lg lg:text-2xl font-roboto absolute top-0 py-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. A sit pharetra augue senectus facilisi. Sit et, tristique posuere iaculis amet. Adipiscing arcu mattis aenean elit dictum risus diam.  </p>
                                    </div>
                                </div>
                                <div className='flex justify-end'>
                                <button type="button" className="drop-shadow-2xl absolute bottom-12 bg-oren3 rounded-lg hover:bg-yellow-700 mx-8 md:my-3 lg:my-4">
                            ...
                            <div className='text-white'>
                                ...
                                <div className="flex justify-start">
                                    <div className="p-5 text-left ">
                                        <h1 className="w-1/2 py-2 md:py-8 lg:py-16 text-lg md:text-2xl lg:text-4xl font-bold font-open-sans absolute top-0">Promo</h1>
                                        <p className="md:w-1/2 lg:w-1/2 py-8 md:py-16 lg:py-32 pr-8 text-xs md:text-lg lg:text-2xl font-roboto absolute top-0 py-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. A sit pharetra augue senectus facilisi. Sit et, tristique posuere iaculis amet. Adipiscing arcu mattis aenean elit dictum risus diam.  </p>
                                    </div>
                                </div>
                                <div className='flex justify-end'>
                    ...
                    <div className="w-auto p-3 lg:p-10 ">
                        <div style={background5} className="p-9 py-12 flex md:justify-start lg:justify-start md:pr-40 lg:pr-48">
                            ...
                            <div className='my-auto md:mx-10 lg:mx-12 text-white'>
                                ...
                                <p className="text-xs py-4 md:text-base lg:text-xl font-roboto">Lorem ipsum dolor sit amet, consectetur adipiscing elit. A sit pharetra augue senectus facilisi. Sit et, tristique posuere iaculis amet. Adipiscing arcu mattis aenean elit dictum risus diam.</p>
                            </div>
                        </div>
                        ...
                        <div style={background7} className="p-9 py-16 mt-6 flex md:justify-start lg:justify-start md:pr-40 lg:pr-48">
                            ...
                            <div className='my-auto md:mx-10 lg:mx-12 text-white'>
                                <h1 className="text-sm md:text-xl lg:text-2xl font-bold font-open-sans">Mau persiapan SBMPTN, tapi waktu udah mepet?</h1>
                                <p className="text-xs py-4 md:text-base lg:text-xl font-roboto">Lorem ipsum dolor sit amet, consectetur adipiscing elit. A sit pharetra augue senectus facilisi. Sit et, tristique posuere iaculis amet. Adipiscing arcu mattis aenean elit dictum risus diam.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className='lg:flex'>
                            ...
                            <div className='my-4 lg:flex-auto lg:w-96 bg-white mx-4 rounded-lg px-12 py-8 drop-shadow-2xl' style={background2}>
                                ...
                                <button type="button" className="w-auto bg-oren3 rounded-lg hover:bg-yellow-700 mt-2 drop-shadow-xl absolute bottom-8 inset-x-1/4">
                                    <Link to="/">
                                        <p className="text-lg px-4 py-2 text-white">Coba Sekarang</p>
                                    </Link>
                                </button>
                            </div>
                    ...
                    <div className='lg:py-16'>
                        ...
                        <div className="grid grid-1 lg:grid-cols-3 p-5 lg:px-36 text-center lg:text-xl">
                            <div className="bg-white rounded-lg mx-12 p-4 drop-shadow-xl my-4">
                                ...
                                <h2 className="font-open-sans font-bold text-center"><br />10.000++</h2>
                                <p className='font-roboto'>Pengguna Ocademy</p>
                            </div>
                            <div className="bg-white rounded-lg mx-12 p-4 drop-shadow-xl my-4">
                                <img src="/images/home-sec4-2.svg" alt="home-sec4-2" className="mx-auto" />
                                <h2 className="font-open-sans font-bold text-center"><br />Ribuan</h2>
                            ...
                            <Carousel showThumbs={false} showStatus={false} autoPlay={true} infiniteLoop={true}>
                                <div className='py-8 bg-white rounded-lg lg:flex lg:text-left p-4' style={background4}>
                                    <div className="rounded-lg px-6 lg:w-1/2">
                                        <img src="/images/dummy_image1.png" alt="dummy_image1" className="py-4 border-4 rounded-full border-oren4"/>
                                    </div>
