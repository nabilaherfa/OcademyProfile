                ...
                <div className="bg-background">
                    ...
                    <div className="grid grid-1 lg:grid-cols-3 lg:px-10" style={background2}>
                        <div className="bg-white rounded-lg p-5 lg:w-64 mx-16 text-center drop-shadow-xl lg:mb-20">
                            ...
                            <p className="text-xl font-roboto">Mencetak generasi saintis berskala Internasional dengan menyediakan bimbingan edukasi yang menarik, berkualitas, dan nyaman digunakan untuk seluruh pelajar di Indonesia.</p>
                        </div>
                        <div className='p-10'>
                    ...
                    <div className="p-10">
                        ...
                        <div className="grid grid-1 lg:flex lg:justify-center">
                            <div className="bg-white text-center rounded-lg p-5 w-48 mx-auto m-2 lg:mb-16" style={background3}>
                                <img src="/images/dummy_image1.png" alt="1" className="border-4 rounded-full border-oren4 mx-auto"/><br />
