...
export class Register extends Component {
    ...
    render() {
        return (
            <>
                <div class="p-10 pb-36 grid grid-1 lg:grid-cols-2 bg-background">
                    <div>
                        <img src="/images/register.svg" alt="register" />
                    </div>
                    <form style={myStyle} class="p-10 bg-white rounded-lg shadow-md w-3/4 mx-auto">
                        <h2 class="text-xl font-bold text-center text-register-title-oren">Register</h2>
                        <div class="mb-6">
                            <label class="block text-sm font-header mb-2 text-register-subtitle-oren font-semibold" for="nama">Nama</label>
                        ...
                        <div class="mb-6">
                            <label class="block text-sm font-header mb-2 text-register-subtitle-oren font-semibold" for="username">Username</label>
                        ...
                        <div class="mb-6">
                            <label class="block text-sm font-header mb-2 text-register-subtitle-oren font-semibold" for="password">Password</label>
                        ...
                        <div class="mb-6">
                            <label class="block text-sm font-header mb-2 text-register-subtitle-oren font-semibold" for="email">Email</label>
                        ...
                        <div class="inline-block relative w-64 mb-6">
                            <label class="block text-sm font-header mb-2 text-register-subtitle-oren font-semibold" for="daftar-apa">Daftar Apa?</label>
                        ...
                        <div class="mb-6">
                            <label class="block text-sm font-header mb-2 text-register-subtitle-oren font-semibold" for="asal-sekolah">Asal Sekolah</label>
                        ...
                        <div class="inline-block relative w-64 mb-6">
                            <label class="block text-sm font-header mb-2 text-register-subtitle-oren font-semibold" for="tau">Tau Ocademy Darimana?</label>
                        ...
                        <div class="flex justify-center">
                            <button type="button" class="bg-oren rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                                <p class="px-10 py-1 text-white font-semibold">Daftar</p>
                            </button>
                        </div>
                        <div class="flex justify-center p-3 text-register-subtitle-oren">
                            <p>Sudah Punya Akun?<a href='#' class="font-bold"> Login</a></p>
                        </div>
                    </form>
                </div>
            </>
